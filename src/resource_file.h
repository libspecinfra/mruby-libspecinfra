...
extern uint32_t resource_file_is_character_device(resource_file_t *f);
static mrb_value resource_file_is_character_device_(mrb_state *mrb, mrb_value self);

extern uint32_t resource_file_is_pipe(resource_file_t *f);
static mrb_value resource_file_is_pipe_(mrb_state *mrb, mrb_value self);

extern uint32_t resource_file_is_socket(resource_file_t *f);
...
extern uint32_t *resource_file_is_writable_by_group(resource_file_t *f);
static mrb_value resource_file_is_writable_by_group_(mrb_state *mrb, mrb_value self);

extern uint32_t *resource_file_is_writable_by_others(resource_file_t *f);
